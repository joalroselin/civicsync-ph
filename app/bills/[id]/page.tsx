...
export default async function BillPage({ params }: { params: { id: string } }) {
  ...
  return (
    <main className="px-5 pb-5">
      ...
      <section className="rounded-[20px] bg-navy p-5 text-white shadow-md">
        ...
        <h2 className="mt-2 font-display text-[22px] font-semibold leading-tight">{title}</h2>
        {bill.subtitle && <p className="mt-2 text-sm leading-relaxed text-indigo-100/90">{toTitleCase(bill.subtitle)}</p>}
      </section>
